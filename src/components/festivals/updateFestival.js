...
export const UpdateFestival = ({row,setTrig}) => {
    ...
    const [festivalPost,setFestivalPost] = useState({
        ...
        nb_table_espace_1 : row.espaces.rows[0].nb_table_espace,
        nb_table_espace_2 : row.espaces.rows[1].nb_table_espace,
        nb_table_espace_3 : row.espaces.rows[2].nb_table_espace,
        prix_table_espace_1 : row.espaces.rows[0].prix_table_espace,
        prix_table_espace_2 : row.espaces.rows[1].prix_table_espace,
        prix_table_espace_3 : row.espaces.rows[2].prix_table_espace,
    })
