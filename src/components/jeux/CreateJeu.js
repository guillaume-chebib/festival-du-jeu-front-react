...
const CreateJeu = ({setTrig, editeurs}) => {
    ...
    const handleCreate = async () => {
        ...
        const response = await requestToBack('POST', {
            titre_jeu: jeu.titre_jeu,
            min_joueur_jeu: jeu.min_joueur_jeu,
            max_joueur_jeu: jeu.max_joueur_jeu,
            id_editeur_jeu: jeu.id_editeur_jeu,
            age_min_jeu: jeu.age_min_jeu,
            duree_jeu: jeu.duree_jeu,
            url_consignes_jeu: jeu.url_consignes_jeu,
            proto_jeu: true
        }, `/jeu`, authHeader())
    ...
    return (
        <div>
            ...
            <ModalJeu titre="Créer jeu" editeurs={editeurs} row={jeu} setRow={setJeu} onClose={handleCloseCreate}
