...
const CreateJeuReserve = ({setTrig, zones, jeux, id_reservation, id_societe}) => {
    ...
    const handleCreate = async () => {
        ...
        const response = await requestToBack('POST', {
            ...
            recu_jeu_reserve: jeuReserve.recu_jeu_reserve,
    ...
    return (
        <div>
            ...
            <ModalJeuReserve titre="Ajouter un jeu" zones={zones} row={jeuReserve} jeux={jeux} setRow={setJeuReserve}
                             onClose={handleCloseCreate} onUpdate={handleCreate} open={openCreate}/>
        </div>
