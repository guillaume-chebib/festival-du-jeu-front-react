...
const AddContact = ({id_societe, setTrig, isEdit}) => {
    ...
    const handleCreate = async () => {
        ...
        const response = await requestToBack('POST', {
            ...
            telephone_portable_contact: contact.telephone_portable_contact,
            telephone_fixe_contact: contact.telephone_fixe_contact,
            fonction_contact: contact.fonction_contact,
            est_principal_contact: contact.est_principal_contact,
